...
//
//        printResult(test,actual,expected)
//    }

    public void buyerSeller(){
        var test =
    ...
    public void instrumentControlling() {
        var test =
