...
class ProjectionThenExtractTests {
    ...
    public void tst1() {
        ...
        var actual = Extraction.extractChoreography(EndPointProjection.project(test).toString());
    ...
    public void tst2() {
        ...
        var testNetwork = "p{def X{if e then q + ok; r + ok; q?; r&{ko: Y, ok: q!<e>; X} else q + ko; r + ko; q&{ko: Z, ok: q!<e>; X}} def Y{q!<e>; X} def Z{q!<e>; Y} main {q!<e>; X}} | " +
