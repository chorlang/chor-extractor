    ...
    public void runningExample(String strategyName, Boolean debugMode) {
        var test =
                "a {def Y {c?; d!<free>; X} def X {if e then b+win; c+lose; b?; Y else b+lose; c+win; b?; Y} main {X}} |" +
                        "b {def X {a&{a win!<sig>; X, a lose!<sig>; X}} main {X}} |" +
                        "c {def X {d!<busy>; a&{a win!<msg>; X, a lose!<msg>; X}} main {X}} |" +
    ...
    public void runningExample2x(String strategyName, Boolean debugMode) {
        var test =
                "a1 {def X {if e then b1+win; c1+lose; b1?; c1?; d1!<free>; X else b1+lose; c1+win; b1?; c1?; d1!<free>; X} main {X}} |" +
                        "b1 {def X {a1&{c1 win!<lose>; a1!<sig>; X, c1 lose?; a1!<sig>; X}} main {X}} |" +
                        "c1 {def X {d1!<busy>; a1&{b1 win!<lose>; a1!<msg>; X, b1 lose?; a1!<msg>; X}} main {X}} |" +
                        "d1 {def X {c1?; a1?; X} main {X}} | " +
                        "a2 {def X {if e then b2+win; c2+lose; b2?; c2?; d2!<free>; X else b2+lose; c2+win; b2?; c2?; d2!<free>; X} main {X}} |" +
                        "b2 {def X {a2&{c2 win!<lose>; a2!<sig>; X, c2 lose?; a2!<sig>; X}} main {X}} |" +
                        "c2 {def X {d2!<busy>; a2&{b2 win!<lose>; a2!<msg>; X, b2 lose?; a2!<msg>; X}} main {X}} |" +
    ...
    public void bargain(String strategyName, Boolean debugMode) {
        var test =
                "a { def X {if notok then b+hag; b?; X else b+happy; c!<info>; stop} main {X}} | " +
                        "b { def Y {a&{a hag!<price>; Y, stop happy}} main {Y}} | " +
                        "c { main {a?; stop}}";
    ...
    public void bargain2x(String strategyName, Boolean debugMode) {
        var test =
                "a { def X {b!<hag>; b?; if price then b+deal; b!<happy>; c!<info>; X else b+nodeal; X} main {X}} | " +
                        "b { def Y {a?; a!<price>; a&{a deal?; Y, Y nodeal}} main {Y}} | " +
                        "c { def Z {a?; Z} main {Z}} | " +
                        "d { def X {e!<hag>; e?; if price then e+deal; e!<happy>; f!<info>; X else e+nodeal; X} main {X}} | " +
                        "e { def Y {d?; d!<price>; d&{d deal?; Y, Y nodeal}} main {Y}} | " +
                        "f { def Z {d?; Z} main {Z}}";
    ...
    public void health(String strategyName, Boolean debugMode) {
        var test =
                "hs{def X{p?; ss!<subscribed>; ss&{" +
                        "p ok+subscribed; as!<account>; as?; t!<fwd>; t?; X, " +
                        "p nok+notSubscribed; X}} main{X}} | " +
                        "p{def X{hs!<sendData>; hs&{es subscribed?; X, X notSubscribed}} main{X}} | " +
    ...
    public void health2x(String strategyName, Boolean debugMode) {
        var test =
                "hs{def X{p?; ss!<subscribed>; ss&{" +
                        ...
                        "p2 ok+subscribed; as2!<account>; as2?; t2!<fwd>; t2?; X, " +
                        "p2 nok+notSubscribed; X}} main{X}} | " +
                        "p2{def X{hs2!<sendData>; hs2&{es2 subscribed?; X, X notSubscribed}} main{X}} | " +
    ...
    public void filter(String strategyName, Boolean debugMode) {
        var test =
                "filter {" +
                        ...
                        "def Y {data&{" +
                        "data item?; if itemToBeFiltered then data!<ok>; Y else data!<remove>; Y," +
                        "X noItem}}" +
                        "main {X}} | " +
                        "data {" +
                        "def X {filter?; Y} " +
    ...
    public void filter2x(String strategyName, Boolean debugMode) {
        var test =
                "filter1 {" +
                        ...
                        "def Y {data1&{" +
                        "data1 item?; if itemToBeFiltered then data1!<ok>; Y else data1!<remove>; Y," +
                        "data1 noItem?; X}}" +
                        "main {X}} | " +
                        "data1 {" +
                        "def X {filter1?; Y} " +
    ...
    public void logistic(String strategyName, Boolean debugMode) {
        var test =
                "supplier {" +
                        ...
                        "def Y {supplier&{X item, retailer done?; stop}}" +
                        "main{Y}}";
    ...
    public void logistic2x(String strategyName, Boolean debugMode) {
        var test =
                "supplier {" +
                        ...
                        "def Y {supplier2&{X item, retailer2 done?; stop}}" +
                        "main{Y}}";
    ...
    public void logistic2(String strategyName, Boolean debugMode) {
        var test =
                "supplier {" +
                        ...
                        "def Z {supplier&{X item, stop done}}" +
                        "main{Z}} | " +
                        "shipper {" +
                        "def X{supplier!<DeliveryItem>; Z} " +
                        "def Z {supplier&{X item, retailer done?; stop}}" +
                        "main{Z}}";
    ...
    public void cloudSystem(String strategyName, Boolean debugMode) {
        var test =
                "cl{" +
                        ...
                        "appli{" +
                        "def X{int?; Y} " +
                        "def Y{cl&{cl awaitcl?; Y, db syncLogout!<log>; cl!<syncLog>; X}} " +
                        "main {X}} | " +
                        "int{" +
    ...
    public void cloudSystem2x(String strategyName, Boolean debugMode) {
        var test =
                "cl{" +
                        ...
                        "appli2{" +
                        "def X{int2?; Y} " +
                        "def Y{cl2&{cl2 awaitcl?; Y, db2 syncLogout!<log>; cl2!<syncLog>; X}} " +
                        "main {X}} | " +
                        "int2{" +
    ...
    public void sanitaryAgency(String strategyName, Boolean debugMode) {
        var test =
                "citizen{" +
                        ...
                        "X refusal, " +
                        "coop acceptance?; bank!<paymentPrivateFee>; X}} " +
                        "main{X}" +
                        "} | " +
                        "sanagency{" +
                        "def X{" +
                        ...
                        "bank{" +
                        "def X{ coop&{" +
                        "coop recMoneyPossT!<paymentT>; Y, " +
                        "coop recMoneyPossM!<paymentM>; Y}} " +
    ...
    public void sanitaryAgency2x(String strategyName, Boolean debugMode) {
        var test =
                "citizen{" +
                        ...
                        "X refusal, " +
                        "coop2 acceptance?; bank2!<paymentPrivateFee>; X}} " +
                        "main{X}" +
                        "} | " +
                        "sanagency2{" +
                        "def X{" +
                        ...
                        "bank2{" +
                        "def X{ coop2&{" +
                        "coop2 recMoneyPossT!<paymentT>; Y, " +
                        "coop2 recMoneyPossM!<paymentM>; Y}} " +
